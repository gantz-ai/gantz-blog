...
summary = "Build an AI tool that turns plain English into SQL. Feed it your database schema for context, validate queries before execution, and prevent dangerous operations like DROP or DELETE. Tutorial covers schema introspection, prompt engineering for SQL generation, and safety guardrails."
