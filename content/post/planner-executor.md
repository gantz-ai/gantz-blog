...
The pattern adds overhead for simple tasks, but for anything with consequences (deployments, data changes, multi-step workflows), that overhead pays for itself in reliability and debuggability.
