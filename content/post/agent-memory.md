...
summary = "Most agents forget everything between sessions - ask the same question twice, get the same confused answer. Build persistent memory: short-term for current conversation, episodic for past interactions, semantic for learned facts, and procedural for how to do things. Use vector databases for retrieval. Your agent remembers what you told it last month."
draft = false
